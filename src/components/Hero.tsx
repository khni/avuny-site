...
import { ContactFormModal } from '@/features/ContactUs/dialog'

export function Hero({ headline, subHeadline }: { headline: string; subHeadline: string }) {
  return (
    <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 bg-linear-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800 ">
      ...
      <div className="max-w-xl text-sm mx-auto  md:text-lg text-neutral-700 dark:text-neutral-400 text-center">
